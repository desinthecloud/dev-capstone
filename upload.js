...
document.getElementById('upload-form').addEventListener('submit', function(e) {
  ...
  fetch(`https://pfx65chy6yoyxss4ynxywa6s2a0ljutj.lambda-url.us-east-1.on.aws/generate-presigned-url?content-type=${encodeURIComponent(contentType)}`) // FUNCTION URL PLACEHOLDER
